...
const launcherExecutablePath = path.join(os.homedir(), 'AppData', 'Local', 'Programs', 'diabolicallauncher', 'Diabolical Launcher.exe');
...
app.on('ready', () => {
    ...
    const executablePath = process.defaultApp && process.argv.includes('--no-sandbox') ? process.execPath : launcherExecutablePath;
