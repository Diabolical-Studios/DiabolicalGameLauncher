...
export default async (request, context) => {
  console.log('=== Netlify Edge Function: get-user-quota ===');
  ...
  try {
    ...
    console.log(`🎯 Fetching quota for session: ${session_id}`);
    ...
    // Make the quota request
    const response = await fetch(`${apiBaseUrl}/rest-api/users/quota`, {
      method: 'POST',
      headers: {
        'x-api-key': apiKey,
