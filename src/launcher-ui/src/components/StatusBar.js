  ...
  useEffect(() => {
    if (window.versions) {
      window.versions.getAppVersion().then((version) => {
        ...
        setAppVersion(`${isDev ? "dev" : "v"}${version}`); // "dev0.3.1"  or  "v0.3.1"
      });
    }
    ...
    const checkStatus = async () => {
      ...
      const [
        ...
        realPing(
          "https://github.com/Diabolical-Studios/DiabolicalGameLauncher/"
        ),
      ...
      const newStatuses = {
        ...
        diabolicalCloudflareBucket: diabolicalCloudflareBucket
          ? "green"
          : "red",
      };
                ...
                <Stack spacing={1} sx={{ padding: 1 }}>
                  ...
                  <Box display="flex" alignItems="center" gap={1}>
                    <Box
                      ...
                      height={10}
                      borderRadius="50%"
                      bgcolor={statuses.diabolicalApi}
                    />
