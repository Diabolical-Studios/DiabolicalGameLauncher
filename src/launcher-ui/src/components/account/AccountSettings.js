...
export const services = [{
    ...
    name: 'Unity', icon: '/logos/unity.svg', description: 'Share your Unity asset packs with your team members.'
}, {
    name: 'Patreon',
...
const imgStyle = {
    width: 24, height: 24, filter: 'invert(100%)', transition: 'filter 0.2s',
};
...
const AccountSettings = ({username}) => {
    ...
    return (<Stack className="overflow-hidden p-3" sx={{width: '100%', maxWidth: "100%", margin: 0}}>
            <Stack className="flex p-5 overflow-auto flex-col gap-5" sx={{
                background: 'rgba(255,255,255,0.01)', borderRadius: '4px', boxShadow: '0 4px 12px 0 rgba(0,0,0,0.04)'
            }}>
                {/* Profile Info */}
                <Stack spacing={1.5}>
                    ...
                    <Stack direction="row" style={{gap: "12px"}} alignItems="center">
                        <TextField
                            ...
                            fullWidth
                            sx={{
                                borderRadius: '4px', background: 'rgba(255,255,255,0.03)', "& .MuiOutlinedInput-root": {
