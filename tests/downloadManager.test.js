...
const { buildsmithPath } = require('../src/js/settings');
...
describe('Download Manager', () => {
  ...
  describe('downloadGame', () => {
    ...
    it('should handle download errors gracefully', async () => {
      ...
      expect(event.sender.send).toHaveBeenCalledWith('download-error', gameId, error.message);
    });
  ...
  describe('extractZip', () => {
    ...
    it('should handle extraction errors', async () => {
      ...
      // Verify error was handled
      expect(event.sender.send).toHaveBeenCalledWith('download-error', gameId, 'Extraction failed');
    });
  });
});
